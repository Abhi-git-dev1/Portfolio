...
function ProjectTile({ position, project, index }) {
...
function Projects3D() {
  const projects = [
    { color: "#ff0000", position: [-3, 1, 0] },
    { color: "#00ff00", position: [0, 0, 0] },
    { color: "#0066ff", position: [3, 1, 0] },
    { color: "#ffff00", position: [-1.5, -1, 1] },
    { color: "#ff00ff", position: [1.5, -1, 1] },
  ]
