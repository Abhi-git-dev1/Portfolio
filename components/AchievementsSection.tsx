          ...
          {[2, 1, 3].map((position) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 1, delay: delays[position as keyof typeof delays] }}
                whileHover={{ scale: 1.05, y: -10 }}
                className={`bg-gradient-to-t ${achievement.color} ${heights[position as keyof typeof heights]} w-32 rounded-t-lg flex flex-col items-center justify-end pb-6 relative cursor-pointer`}
              >
